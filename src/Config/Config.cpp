...
float PICK_FORK_EXTENSION_INCHES = 2.5;   // Fork extension distance for pick operation (inches)
...
float PLACE_FORK_EXTENSION_INCHES = 1.8;   // Fork extension distance for place operation (inches)
