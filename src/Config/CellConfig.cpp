...
float CELL_HEIGHTS[TOTAL_ROWS][TOTAL_COLUMNS] = {
    {9.645,  0.0,  9.645,  0.0}, // Row 1 (A1, B1 removed, C1, D1 removed)
    {7.716,  7.487,  7.716,  0.0}, // Row 2 (A2, B2, C2, D2 removed)
    {5.787,  5.56,  5.787,  5.56}, // Row 3 (A3, B3, C3, D3)
    {3.858,  3.629,  3.858,  3.629}, // Row 4 (A4, B4, C4, D4)
    {2.665,  1.7,  2.665,  1.7}  // Row 5 (A5, B5, C5, D5)
};
