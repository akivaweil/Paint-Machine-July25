...
float CELL_HEIGHTS[TOTAL_ROWS][TOTAL_COLUMNS] = {
    {1.1,  4.0,  5.0,  6.0}, // Row 1 (A1, B1, C1, D1)
    {3.6,  4.1,  5.1,  6.1}, // Row 2 (A2, B2, C2, D2)
    {6.3,  4.3,  5.3,  6.3}, // Row 3 (A3, B3, C3, D3)
    {8.9,  4.5,  5.5,  6.5}, // Row 4 (A4, B4, C4, D4)
    {11.5,  4.7,  5.7,  6.7}  // Row 5 (A5, B5, C5, D5)
};
