...
public:
    ...
    void extendToCellPickPosition();          // Move to cell pick position using cell config distance
    void extendToCellPlacePosition();         // Move to cell place position using cell config distance
