...
float RETRIEVE_HEIGHT_INCHES = 3.8;   // Height to move to for retrieve operation (5 inches)
...
float STORE_HEIGHT_INCHES = (2 * RETRIEVE_HEIGHT_INCHES) + 0.5;      // Height to move to for store operation (8 inches)
