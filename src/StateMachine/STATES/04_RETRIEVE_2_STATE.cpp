...
void executeRetrieve2State() {
    ...
    switch (currentStep) {
        ...
        case 5: {
            ...
            //! ************************************************************************
            bool heightAdjustmentComplete = !retrieve2ZMotor || !retrieve2ZMotor->isRunning();
        ...
        case 8: {
            ...
            if (currentTime - stepStartTime >= CYLINDER_RETRACT_WAIT) {
                Serial.println("Step 8: Cylinder retract wait complete, second retrieval sequence finished");
